    ...
    <div class="row mt-5">
            ...
            <div class="carousel slide" data-ride="carousel" id="carouselExample2"
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img alt="img" class="d-block w-100" src="https://via.placeholder.com/800x500">
                    </div>
        ...
        <div class="col-md-4">
            ...
            <div class="side-images">
                <img src="https://via.placeholder.com/250x150" alt="Side Image 1" class="img-fluid">
                <img src="https://via.placeholder.com/250x150" alt="Side Image 2" class="img-fluid">
                <img src="https://via.placeholder.com/250x150" alt="Side Image 3" class="img-fluid">
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card" style="padding:15px">
                ...
                @if($real_estate_post->listing_type === 'rent')
                        <h2>
                            <span class="text-danger">${{ intval($real_estate_post->price) == $real_estate_post->price ? number_format($real_estate_post->price, 0) : number_format($real_estate_post->price, 2) }} </span><sup>/month</sup>
                        </h2>
                @else
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10 ">
                            <p class="m-0">{{ round($real_estate_post->price / $real_estate_post->sqft, 0) }}</p>
                    ...
                    @if($real_estate_post->year_built >1000 )
                        <div class="row">
                            <div class="col-2 py-1 px-2 text-center">
                                <svg data-testid="icon-hammer" viewBox="0 0 24 24" aria-hidden="true" focusable="false"
                                     style="display: inline-block; width: 1em; height: 1em; font-size: 24px; color: inherit; fill: currentcolor;">
                                    <path fill-rule="evenodd"
                    ...
                    @if($real_estate_post->garage > 0 )
                        <div class="row">
                            <div class="col-2 py-1 px-2 text-center">
                                <svg data-testid="icon-garage" viewBox="0 0 24 24" aria-hidden="true" focusable="false"
                                     style="display: inline-block; width: 1em; height: 1em; font-size: 24px; color: inherit; fill: currentcolor;">
                                    <path
                                        d="M10 13a1 1 0 0 1 1-1h2a1 1 0 1 1 0 2h-2a1 1 0 0 1-1-1Zm1 2a1 1 0 1 0 0 2h2a1 1 0 1 0 0-2h-2Z"></path>
                                    <path fill-rule="evenodd"
                            ...
                            <div class="col-10">
                                <p class="m-0  mx-1">{{ $real_estate_post->garage }}{{ $real_estate_post->garage === 1 ? ' Car' : ' Cars'}} </p>
