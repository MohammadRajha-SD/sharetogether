...
<div class="row">
    <div class="col-12 d-flex align-items-center justify-content-end">
        <a class="btn btn-warning mb-3 text-white" data-bs-toggle="tooltip" title="Favorites">
                ...
                <div class="card d-flex flex-column h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <i class="bi bi-lock text-muted" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Private Post"></i>
                            @else
                            <i class="bi bi-unlock text-muted" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Public Post"></i>
                            @endif
                        </div>
                    ...
                    <div class="card-footer">
                        <small class="text-muted">Address: {{ $post->address }}, {{ $post->city }}, {{ $post->state
                            }}</small>
                    </div>
                </div>
            </a>
